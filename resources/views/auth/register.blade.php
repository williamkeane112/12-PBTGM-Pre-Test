        ...
        <div class="mt-10 px-7">
            ...
            @csrf
                <div class="mb-4">
                    ...
                    <input type="text" id="name" name="name" class="shadow-lg appearance-none  rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline border border-blue-500">
                </div>            
                <div class="mb-4">
                ...
                <div class="mb-4 text-center">
                    <a href="/login"  class="w-full text-red-500 hover:text-red-700 hover:underline duration-300 rounded py-2">Have Account?</a>
                </div>    
            </form>    
        </div>
    </div>
